        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (Build.VERSION.SDK_INT>15) {
                    ...
                    intentBuilder.setToolbarColor(ContextCompat.getColor(poc.this, R.color.colorPrimary));
                    intentBuilder.setSecondaryToolbarColor(ContextCompat.getColor(poc.this, R.color.colorPrimaryDark));
                    intentBuilder.setStartAnimations(poc.this, android.R.anim.fade_in, android.R.anim.fade_out);
                    intentBuilder.setExitAnimations(poc.this, android.R.anim.fade_in, android.R.anim.fade_out);
                    CustomTabsIntent customTabsIntent = intentBuilder.build();
                    customTabsIntent.launchUrl(poc.this, uri);
                }else {
