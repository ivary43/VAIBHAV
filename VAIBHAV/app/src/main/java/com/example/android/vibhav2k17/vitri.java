        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (Build.VERSION.SDK_INT>15) {
                    ...
                    intentBuilder.setToolbarColor(ContextCompat.getColor(vitri.this, R.color.colorPrimary));
                    intentBuilder.setSecondaryToolbarColor(ContextCompat.getColor(vitri.this, R.color.colorPrimaryDark));
                    intentBuilder.setStartAnimations(vitri.this, android.R.anim.fade_in, android.R.anim.fade_out);
                    intentBuilder.setExitAnimations(vitri.this, android.R.anim.fade_in, android.R.anim.fade_out);
                    CustomTabsIntent customTabsIntent = intentBuilder.build();
                    customTabsIntent.launchUrl(vitri.this, uri);
                }else {
