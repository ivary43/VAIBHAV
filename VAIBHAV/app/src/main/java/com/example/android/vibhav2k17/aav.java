...
public class aav extends AppCompatActivity {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (Build.VERSION.SDK_INT>15) {
                    ...
                    intentBuilder.setToolbarColor(ContextCompat.getColor(aav.this, R.color.colorPrimary));
                    intentBuilder.setSecondaryToolbarColor(ContextCompat.getColor(aav.this, R.color.colorPrimaryDark));
                    intentBuilder.setStartAnimations(aav.this, android.R.anim.fade_in, android.R.anim.fade_out);
                    intentBuilder.setExitAnimations(aav.this, android.R.anim.fade_in, android.R.anim.fade_out);
                    CustomTabsIntent customTabsIntent = intentBuilder.build();
                    customTabsIntent.launchUrl(aav.this, uri);
                }else {
    ...
    public void about(View view){
        about_builder= new AlertDialog.Builder(aav.this);
    ...
    public void rules(View view){
        rules_builder= new AlertDialog.Builder(aav.this);
    ...
    public void judgingCriteria(View view){
        judgingCriteria_builder= new AlertDialog.Builder(aav.this);
    ...
    public void prizes(View view){
        prizes_builder= new AlertDialog.Builder(aav.this);
    ...
    public void contactUs(View view){
        contactUs_builder= new AlertDialog.Builder(aav.this);
